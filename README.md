...
A checkout customization plugin with field prioritization and phone validation.
...
Copy this repository into `wp-content/plugins/woocommerce-checkout-optimizer`, activate it, then open **Settings → WooCommerce Checkout Optimizer**.
